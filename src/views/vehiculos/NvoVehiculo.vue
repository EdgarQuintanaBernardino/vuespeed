        ...
        <CCollapse :show="collapse">
          <p>
            <CRow>
              <CCol sm="">
                  <!-- <h4
                  :to="{ name: 'cliente', params: { id: $route.params.id }}"
                ...
                <span v-else v-text="$route.params.id" />
                  ...
                  :value.sync="$v.form.cliente.$model"
                ...
                >
                <!--Valida que el campo es obligatorio-->
              </CCol>
...
//Registrar usuario
 ...
 let self = this;
      self.submitted = true;
      self.errors = [];
      self.form.val_ant_cli = self.form.name;
        ...
        .post(
          ...
          self.submitted = false;
            ...
            .catch(function(error) {
              self.submitted = false;
          self.form.name = self.form.val_ant_cli;
